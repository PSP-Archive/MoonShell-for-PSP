 ...
 *                     \/            \/     \/    \/            \/
 * $Id: codecs.h 29846 2011-05-09 19:34:45Z Buschel $
 *
...
#define DEBUGF conout
#define LDEBUGF conout
#define LOGF conout
...
int codec_load_buf(int hid, struct _codec_api *api);
int codec_load_file(const char* codec, struct _codec_api *api);
