...
int LibSndGME_FadeOutGain_Shift14;
...
{
	{
		...
		int gain = int_log( (out_time - fade_start) / fade_block_size, fade_step, unit );
		LibSndGME_FadeOutGain_Shift14=gain;
	}
...
blargg_err_t Music_Emu::play( long out_count, sample_t* out )
{
	...
	else
	{
		...
		if ( out_time > fade_start ){
			...
			LibSndGME_FadeOutGain_Shift14=1<<14;
		}
	}
	out_time += out_count;
	return 0;
