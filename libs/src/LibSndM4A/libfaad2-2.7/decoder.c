...
#ifdef PROFILE
    conout("AAC decoder total:  %I64d cycles\n", hDecoder->cycles);
    conout("requant:            %I64d cycles\n", hDecoder->requant_cycles);
    conout("spectral_data:      %I64d cycles\n", hDecoder->spectral_cycles);
    conout("scalefactors:       %I64d cycles\n", hDecoder->scalefac_cycles);
    conout("output:             %I64d cycles\n", hDecoder->output_cycles);
#endif
