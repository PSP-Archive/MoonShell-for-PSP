...
extern MDX_DATA *mdx_open_mdx( const u8 *pmdxbuf,const u32 mdxbufsize );
extern PDX_DATA *mdx_open_pdx( const u8 *ppdxbuf,const u32 pdxbufsize );
extern int mdx_close_mdx( MDX_DATA * );
extern int mdx_close_pdx( PDX_DATA * );
extern int mdx_get_voice_parameter( MDX_DATA * );
extern int mdx_parse_mml_ym2151_Start( MDX_DATA *, PDX_DATA * , u32 SampleRate, u32 SamplesPerFrame);
extern bool mdx_parse_mml_ym2151_Loop(u32 *pPCMBuf32,double FrameTime);
extern void mdx_parse_mml_ym2151_End(void);
