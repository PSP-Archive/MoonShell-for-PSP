...
%.o: %.c $(DependPath)
	$(CXX) $(CFLAGS) $(DEPENDFLAGS) -c -o $@ $<

%.o: %.cpp $(DependPath)
	$(CXX) $(CXXFLAGS) $(DEPENDFLAGS) -c -o $@ $<

$(DependPath):
	-mkdir $(DependPath)

clean: 
	-rm -f $(FINAL_TARGET) $(EXTRA_CLEAN) $(OBJS) $(PSP_EBOOT_SFO) $(PSP_EBOOT) $(EXTRA_TARGETS) $(OBJS)
	-rm -f $(wildcard $(DependPath)/*.d)
	-rmdir $(DependPath)
